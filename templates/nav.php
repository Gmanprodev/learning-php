    ...
    <div class="navbar-fixed">
        <nav class="nav-extended text-shadow teal lighten-2">
            <div class="nav-wrapper">
                <a href="/" class="logo left-align">TaskRunner</a>
                <a href="#" data-target="mobile-demo" class="sidenav-trigger right"><i class="fas fa-bars"></i></a>
                <ul class="right hide-on-med-and-down">
                    <li><a href="">Profile</a></li>
                    <li><a href="/views/tasks.view.php">Tasks</a></li>
                    <li><a href="/views/add_tasks.view.php">Add Tasks</a></li>
                    <li><a href="">Log Out</a></li>
                    <li><a href="/">Home</a></li>
                    <li><a href="/views/login.view.php">Log In</a></li>
